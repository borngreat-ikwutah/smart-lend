  ...
  if (!user?.loggedIn) {
    return (
      <Button
        ...
        className={`bg-gradient-to-r from-blue-500/80 to-purple-500/80 hover:from-blue-600/90 hover:to-purple-600/90 text-white border border-blue-400/30 backdrop-blur-sm ${className}`}
      >
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          className={`border-gray-500/30 hover:border-gray-400/50 bg-gray-900/30 hover:bg-gray-800/40 backdrop-blur-sm ${className}`}
        >
          <Avatar className="w-6 h-6 mr-2">
            <AvatarImage src="" />
            <AvatarFallback className="bg-gradient-to-br from-blue-500/80 to-purple-500/80 text-white text-xs">
      ...
      <DropdownMenuContent className="w-64 bg-gray-900/95 border-gray-600/30 backdrop-blur-sm">
        <div className="px-3 py-2 border-b border-gray-700/50">
          <div className="flex items-center gap-3">
            <Avatar className="w-10 h-10">
              <AvatarImage src="" />
              <AvatarFallback className="bg-gradient-to-br from-blue-500/80 to-purple-500/80 text-white">
                {getUserInitials(user.addr)}
              </AvatarFallback>
            </Avatar>
